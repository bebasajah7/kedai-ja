          ...
          <div className="p-4 sm:p-6">
            <div className="space-y-4">
              {bestSellerMenus.map((item) => (
                <div key={item._id} className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors duration-200">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between">
                      ...
                      <button
                        ...
                        className="ml-4 text-red-600 hover:text-red-900 transition-colors duration-200 text-sm font-medium flex-shrink-0"
                      >
                        Hapus
                      </button>
                    </div>
            ...
            <div className="p-4 sm:p-6 border-b border-gray-200 space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm"
                />
              </div>
