...
import { ArrowLeft, Star, ChefHat, AlertCircle, Plus, X } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          ...
          className="bg-orange-500 text-white px-4 py-2 rounded-lg flex items-center space-x-2 hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
        >
      ...
      {/* Current Best Sellers Table */}
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-bold text-gray-900">Menu Best Seller Saat Ini</h2>
        </div>
        
        {bestSellerMenus.length === 0 ? (
          <div className="text-center py-12">
            <Star className="h-16 w-16 text-gray-400 mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Belum ada best seller</h3>
            <p className="text-gray-600">Klik "Tambah Best Seller" untuk menambah menu favorit</p>
          </div>
        ) : (
                      ...
                      <div className="flex items-center">
                        <div className="h-12 w-12 flex-shrink-0">
                          {item.image ? (
                            ...
                            <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-orange-400 to-red-400 flex items-center justify-center">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-4xl w-full max-h-[80vh] overflow-hidden">
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <h2 className="text-xl font-bold text-gray-900">Pilih Menu untuk Best Seller</h2>
              <button
              ...
              {nonBestSellerMenus.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {nonBestSellerMenus.map((item) => (
                    <div key={item._id} className="border border-gray-200 rounded-lg p-4 hover:border-orange-300 transition-colors duration-200">
                      <div className="flex items-center space-x-4">
                        <div className="h-16 w-16 flex-shrink-0">
                          {item.image ? (
                            <img className="h-16 w-16 rounded-lg object-cover" src={item.image} alt={item.name} />
                          ) : (
                            <div className="h-16 w-16 rounded-lg bg-gradient-to-br from-orange-400 to-red-400 flex items-center justify-center">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <button
                            ...
                            disabled={bestSellerIds.length >= 6}
                            className="mt-3 w-full bg-yellow-500 text-white py-2 px-4 rounded-md hover:bg-yellow-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 flex items-center justify-center text-sm"
                          >
